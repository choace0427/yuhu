...
export default function MassageCard({ src = "", title = "", body = "" }) {
  return (
    <div className="flex flex-col items-center justify-center lg:gap-4 md:gap-3 gap-2 md:w-[240px] w-[190px] md:h-[460px] h-[300px] border lg:p-4 md:p-3 p-2 rounded-lg ">
      <Image
      ...
      <div className="flex flex-col justify-between h-full items-center">
        ...
        <button className="w-24 font-bold Poppins-font border-b-2 border-[#46A7B0] animate-pulse">
