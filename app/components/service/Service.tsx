...
export default function Service({ src = "", title = "", body = "" }) {
  return (
    <div className="sm:w-[420px] w-[400px] h-[580px] flex shadow-2xl justify-center items-center p-6 rounded-md">
      <div className="flex flex-col lg:gap-4 md:gap-3 gap-2 items-center justify-center">
        ...
        <span className="font-bold md:text-2xl text-xl Poppins-font">
          {title}
        </span>
        <span className="Poppins-font text-center md:text-base text-sm">
          {body}
        </span>
        <button className="font-bold Poppins-font border-b-2 border-[#46A7B0] animate-pulse">
